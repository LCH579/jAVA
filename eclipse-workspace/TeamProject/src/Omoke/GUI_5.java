...
import Yuckmok.MouseEventHandler;
...
public class GUI_5 extends JFrame {
	private Container c;
	MapSize_5 size = new MapSize_5();
	final Map_5 map = new Map_5(size);
	final DrawBoard_5 d = new DrawBoard_5(size,map);
	final MouseEventHandler_5 meh = new MouseEventHandler_5(map, size, d, this);
	
	
	public GUI_5(String title) {
		super.setTitle(title);
		c= getContentPane();
		setBounds(200,20,650,740);
		setContentPane(d);
		...
		JButton newgame = new JButton(new AbstractAction("Delete") {
			@Override
			public void actionPerformed(ActionEvent e){
				meh.newGame();
			}
